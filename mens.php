        ...
        <div class=" container-fluid  " style=" background-color: rgb(236, 233, 233);">
            <div class="row">
                <div class="col-lg-4  d-flex justify-content-center  me-auto">
                    ...
                    <h4 class="nav-link mt-4  mx-5 ">Mens Section</h4>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-8 col-sm-6">
                        <div data-v-6962874a="" class="newbread"><a data-v-6962874a="" href="index.php"
                                class="">Home</a>
                            <!---->
                            / <span data-v-6962874a="">Mens's shirt</span> <!---->
                            <h4 data-v-6962874a="" class="list-header mt-1">Men Shirts
                    ...
                    <div class="row">
                        <div class="col-3 mb-3">
                            ...
                            <div class="card border-0 shadow " style="max-width: 350px; margin: auto; ">
                                <a href=""><img src="Images/Mens/men1.jpg" class="card-img-top" alt="...">
